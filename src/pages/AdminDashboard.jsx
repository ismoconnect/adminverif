  ...
  const fetchSubmissions = async () => {
    try {
      ...
      setStats({
        ...
        verified: globalStats.verified || 0,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 flex flex-col md:flex-row items-center justify-between gap-4">
              <div>
                <h2 className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-1">Volume Global (Soumissions + Remboursements)</h2>
                <div className="text-4xl font-black text-slate-900">
                  {((stats.totalAmount || 0) + (refundStats.totalAmount || 0)).toFixed(2)} €
                </div>
              </div>
              <div className="flex gap-4">
                <div className="text-right">
                  <p className="text-xs font-bold text-slate-400">Total Opérations</p>
                  <p className="text-xl font-black text-blue-600">{stats.total + refundStats.total}</p>
                </div>
                <div className="w-px h-10 bg-slate-100 hidden md:block"></div>
                <div className="text-right">
                  <p className="text-xs font-bold text-slate-400">Taux de succès</p>
                  <p className="text-xl font-black text-green-600">
                    {stats.total + refundStats.total > 0
                      ? (((stats.verified + refundStats.approved + refundStats.completed) / (stats.total + refundStats.total)) * 100).toFixed(0)
                      : 0}%
                  </p>
                </div>
              </div>
          ...
          <div className="mb-6 flex justify-between items-end">
            ...
            <div className="text-right hidden sm:block">
              <p className="text-xs font-bold text-slate-400 uppercase">Valeur totale des coupons</p>
              <p className="text-lg font-black text-blue-600">{stats.totalAmount.toFixed(2)} €</p>
            </div>
          </div>
            ...
            <div className="bg-white overflow-hidden shadow-lg rounded-xl border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">Valeur coupons</dt>
                      <dd className="text-2xl font-bold text-gray-900">{stats.totalAmount.toFixed(2)} €</dd>
                    </dl>
                  </div>
                </div>
              </div>
                    ...
                    <div className="ml-4 flex-1">
                      <dl>
                        ...
                        <dd className="text-2xl font-bold text-gray-900">
                          {(refundStats.approved || 0) + (refundStats.completed || 0)}
                        </dd>
                      </dl>
                    </div>
                  </div>
